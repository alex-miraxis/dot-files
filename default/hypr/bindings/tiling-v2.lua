...
o.bind("CTRL + ALT + DELETE", "Close all windows", "archy-hyprland-window-close-all")
...
o.bind("SUPER + O", "Pop window out (float & pin)", "archy-hyprland-window-pop")
o.bind("SUPER + L", "Toggle workspace layout", "archy-hyprland-workspace-layout-toggle")
...
o.bind("SUPER + code:61", "Cycle monitor scaling", "archy-hyprland-monitor-scaling-cycle")
o.bind("SUPER + ALT + code:61", "Cycle monitor scaling backwards", "archy-hyprland-monitor-scaling-cycle --reverse")
