...
o.window("(org.archy.bluetui|org.archy.impala|org.archy.wiremix|org.archy.btop|org.archy.terminal|org.archy.bash|org.codeberg.dnkl.foot|org.gnome.NautilusPreviewer|org.gnome.Evince|com.gabm.satty|Arch|About|TUI.float|imv|mpv)", { tag = "+floating-window" })
...
o.window("org.archy.screensaver", { fullscreen = true, float = true, animation = "slide" })
...
hl.layer_rule({ match = { namespace = "archy-image-selector" }, no_anim = true })
