...
ShellRoot {
  ...
  property string imageDirs: Quickshell.env("ARCHY_IMAGE_SELECTOR_DIRS") || Quickshell.env("ARCHY_IMAGE_SELECTOR_DIR") || Quickshell.env("ARCHY_STOCK_BACKGROUNDS_DIR") || (Quickshell.env("HOME") + "/.config/archy/current/theme/backgrounds")
  property string imageRows: ""
  property string selectionFile: Quickshell.env("ARCHY_IMAGE_SELECTOR_SELECTION_FILE") || Quickshell.env("ARCHY_BACKGROUND_SELECTION_FILE")
  property string selectedImage: Quickshell.env("ARCHY_IMAGE_SELECTOR_SELECTED")
  property string colorsFile: Quickshell.env("ARCHY_IMAGE_SELECTOR_COLORS_FILE") || (Quickshell.env("HOME") + "/.config/archy/current/theme/quickshell.json")
  ...
  property string socketPath: (Quickshell.env("XDG_RUNTIME_DIR") || ("/run/user/" + Quickshell.env("UID"))) + "/archy-image-selector.sock"
  ...
  function openSelector(nextImageDirs, nextImageRows, nextSelectedImage, nextSelectionFile, nextDoneFile, nextColorsFile, nextColorsRaw, nextShowLabels, nextFilterable) {
    ...
    filterText = ""
    colorsFile = nextColorsFile || (Quickshell.env("HOME") + "/.config/archy/current/theme/quickshell.json")
    if (nextColorsRaw)
  ...
  Component.onCompleted: {
    if (selectionFile)
      openSelector(imageDirs, "", selectedImage, selectionFile, Quickshell.env("ARCHY_IMAGE_SELECTOR_DONE_FILE"), colorsFile, "", false, false)
  }
  ...
  PanelWindow {
    ...
    color: "transparent"
    WlrLayershell.namespace: "archy-image-selector"
