--
-- Dynamic Arch Theme Menu for Elephant/Walker
--
Name = "archythemes"
NamePretty = "Arch Themes"
...
function GetEntries()
  local entries = {}
  local user_theme_dir = os.getenv("HOME") .. "/.config/archy/themes"
  local archy_path = os.getenv("ARCHY_PATH") or ""
  local default_theme_dir = archy_path .. "/themes"
      ...
      if theme_name and not seen_themes[theme_name] then
        ...
        if preview_path and preview_path ~= "" then
          ...
          table.insert(entries, {
            ...
            PreviewType = "file",
            Actions = {
              activate = "archy-theme-set " .. theme_name,
            },
          })
        end
      end
