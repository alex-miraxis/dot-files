...
o.bind("SUPER + ALT + RETURN", "Tmux", { archy = "terminal-tmux" })
...
o.bind("SUPER + SHIFT + M", "Music", { archy = "or-focus spotify" })
...
-- o.bind("SUPER + SPACE", "Arch menu", "archy-menu")

-- Logitech MX Keys examples:
-- o.bind("SUPER + SHIFT + S", nil, "archy-capture-screenshot")
-- o.bind("SUPER + H", nil, "voxtype record toggle")
-- o.bind("SUPER + PERIOD", nil, { archy = "walker -m symbols" })
