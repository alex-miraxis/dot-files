...
local archy_gdk_scale = 1
local archy_monitor_scale = 1

-- Optimized for retina-class 2x displays, like 13" 2.8K, 27" 5K, 32" 6K.
-- local archy_gdk_scale = 2
-- local archy_monitor_scale = "auto"

-- Good compromise for 27" or 32" 4K monitors (but fractional!): monitor scale 1.6, GDK scale 1.75.
-- local archy_gdk_scale = 1.75
-- local archy_monitor_scale = 1.6

-- Straight 1x setup for low-resolution displays like 1080p, 1440p, or ultrawides: both 1.
-- local archy_gdk_scale = 1
-- local archy_monitor_scale = 1

hl.env("GDK_SCALE", tostring(archy_gdk_scale))
hl.monitor({ output = "", mode = "preferred", position = "auto", scale = archy_monitor_scale })
